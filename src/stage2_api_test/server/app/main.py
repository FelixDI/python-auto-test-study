...
#
# # 数据库配置 (连接 MySQL)
# SQLALCHEMY_DATABASE_URL = "mysql+pymysql://root:root123@db:3306/ecommerce"
...
## 容器之间实现fastapi连接mysql，排除环境搭建问题、接口定义缺失（没有商品/订单接口）、基础设施（JWT 鉴权、表结构）
# 再出现的问题都是开发代码健壮性不够，不再更改main.py而是要在测试报告中体现
# deepseek提供的 被测试对象 fastapi web
# chatgpt直接指出了main.py代码很多问题，由此意识到测试代码应该关注这些问题。
